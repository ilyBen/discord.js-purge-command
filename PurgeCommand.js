...
module.exports = class PurgeCommand extends BaseCommand {
 ...
 async run(client, message, args) {
    ...
    if (isNaN(amonutToDelete)) return message.channel.send('Number stated it not a valid number.');
    ...
    try {
      ...
      console.log(err);
      message.channel.send('I was unable to delete the amount stated make sure they are within 14 days.');
    }
  }
}